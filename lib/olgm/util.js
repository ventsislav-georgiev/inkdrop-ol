...
const { geom, Feature, extent, style, layer } = ol;
const { Point, Polygon } = geom;
 ...
 */
module.exports.getCenterOf = getCenterOf;
 ...
 */
module.exports.getColorOpacity = getColorOpacity;
 ...
 */
module.exports.getStyleOf = getStyleOf;
function getStyleOf(object) {
 ...
 */
module.exports.getZoomFromResolution = getZoomFromResolution;
function getZoomFromResolution(resolution, minZoom) {
  minZoom = minZoom || 0;
...
function stringStartsWith(string, needle) {
