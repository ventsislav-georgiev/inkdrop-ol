...
const { geom, proj, style } = ol;
const { LineString, Point, Polygon, MultiLineString, MultiPolygon, MultiPoint } = geom;
const { transform } = proj;
const { Circle, Icon, RegularShape } = style;
...
function createFeature(feature, opt_ol3map) {
 ...
 */
module.exports.createFeatureGeometry = createFeatureGeometry;
function createFeatureGeometry(geometry, opt_ol3map) {
 ...
 */
module.exports.createLatLng = createLatLng;
function createLatLng(object, opt_ol3map) {
 ...
 */
module.exports.createGeometry = createGeometry;
function createGeometry(geometry, opt_ol3map) {
  const inProj = (opt_ol3map !== undefined) ?
    opt_ol3map.getView().getProjection() : 'EPSG:3857';
 ...
 * @private
 */
module.exports.genLatLngs_ = genLatLngs_;
function genLatLngs_(coordinates, opt_inProj) {
 ...
 * @private
 */
module.exports.genMultiLatLngs_ = genMultiLatLngs_;
function genMultiLatLngs_(coordinates, opt_inProj) {
  const inProj = opt_inProj || 'EPSG:3857';
  const multiLatLngs = [];
 ...
 * @private
 */
module.exports.genMultiPolygon_ = genMultiPolygon_;
function genMultiPolygon_(polygons, opt_inProj) {
  const mutliPolygons = [];
...
function createStyle(object, mapIconOptions, opt_index) {
  let gmStyle = null;
 ...
 * @return {google.maps.Data.StyleOptions} google style options
 */
module.exports.createStyleInternal = createStyleInternal;
function createStyleInternal(style, mapIconOptions, opt_index) {
...
function createLabel(textStyle, latLng, index, opt_pane) {
 ...
 */
module.exports.createMapIcon = createMapIcon;
function createMapIcon(iconStyle, latLng, index, opt_pane) {
